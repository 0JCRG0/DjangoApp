...
async def get_additional_jobs(user_id: int, user_country_1: str, user_country_2: str | None, user_cv:str, limit_interval: int, num_suitable_jobs: int):
	...
	df = fetch_similar_jobs_not_matched(user_id, user_query_embedding, all_country_values, cursor, similarity_or_distance_metric="NN")
...
if __name__ == "__main__":
	asyncio.run(get_additional_jobs(user_id=40, user_country_1="United States", user_country_2="Anywhere", user_cv=cv, limit_interval=5, num_suitable_jobs=2))
